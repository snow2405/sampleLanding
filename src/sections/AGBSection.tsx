        ...
        <div className="agb-container">
          ...
          <div className="agb-content">
            <div className="agb-card">
              ...
              <a href="#privacy-policy" className="full-terms-link">
            ...
            <div className="agb-card">
              ...
              <a href="#terms-of-use" className="full-terms-link">
        ...
        <div className="legal-container">
          ...
          <div id="privacy-policy" className="legal-document">
            ...
            <div className="legal-content">
              ...
              <h4>3.2 Automatically Collected Information</h4>
              <ul>
              ...
              <h4>9.1 GDPR Rights (European Economic Area, UK, Switzerland)</h4>
              <ul>
              ...
              <h4>9.2 Swiss Data Protection Rights</h4>
              <p>
              ...
              <h4>9.3 California Privacy Rights (CCPA/CPRA)</h4>
              ...
              <h4>9.4 How to Exercise Your Rights</h4>
              <p>
              ...
              <h3>16. Supervisory Authority</h3>
              <p>
          ...
          <div id="terms-of-use" className="legal-document">
            ...
            <div className="legal-content">
              ...
              <h3>5. License and Intellectual Property</h3>
              
              <h4>5.1 License to Use Service</h4>
              <p>
              ...
              <h4>5.3 Our Intellectual Property</h4>
              <p>
              ...
              <h3>6. Privacy and Data Processing</h3>
              <p>
              ...
              <h3>7. Payment and Subscriptions</h3>
              ...
              <h3>8. Content Moderation and Enforcement</h3>
              ...
              <h4>13.2 Arbitration (If Applicable)</h4>
              <p>
              ...
              <h4>15.6 Contact for Legal Matters</h4>
              <p>
              ...
              <h3>16. Special Provisions for Specific Jurisdictions</h3>
              
              <h4>16.1 European Union Users</h4>
              <p>
              ...
              <h3>17. Safety and Meeting Guidelines</h3>
              <p>
